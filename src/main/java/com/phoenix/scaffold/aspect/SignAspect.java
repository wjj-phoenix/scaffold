...
import com.phoenix.scaffold.exception.BusinessException;
import com.phoenix.scaffold.utils.SignUtil;
...
public class SignAspect {
     ...
     * pointcut.
     */
    @Pointcut("execution(@com.phoenix.scaffold.annotation.Signature * *(..))")
